...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Th\u1ECF</span><span id="Pond_counterName">Ng\u01B0\u1EDDi t\u00EDnh \u0111\u1EBFm</span><span id="Pond_rookName">Con xe</span><span id="Pond_sniperName">Ng\u01B0\u1EDDi n\u00FAp b\u1EAFn</span><span id="Pond_myName">Ng\u01B0\u1EDDi ch\u01A1i</span></div>';
};
if (goog.DEBUG) {
