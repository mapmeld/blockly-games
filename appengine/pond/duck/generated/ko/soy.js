...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">\uD1A0\uB07C</span><span id="Pond_counterName">\uACC4\uC0B0\uC6D0</span><span id="Pond_rookName">\uB8E8\uD06C</span><span id="Pond_sniperName">\uC800\uACA9\uC218</span><span id="Pond_myName">\uD50C\uB808\uC774\uC5B4</span></div>';
};
if (goog.DEBUG) {
