...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Coelho</span><span id="Pond_counterName">Contador</span><span id="Pond_rookName">Torre</span><span id="Pond_sniperName">Francoatirador</span><span id="Pond_myName">Jogador</span></div>';
};
if (goog.DEBUG) {
