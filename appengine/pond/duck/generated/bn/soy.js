...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">\u0996\u09B0\u0997\u09CB\u09B6</span><span id="Pond_counterName">\u0997\u09A3\u09A8\u09BE\u0995\u09BE\u09B0\u09C0</span><span id="Pond_rookName">\u09A6\u09BE\u09AC\u09BE\u09B0 \u09A8\u09CC\u0995\u09BE</span><span id="Pond_sniperName">\u09B8\u09CD\u09A8\u09BE\u0987\u09AA\u09BE\u09B0</span><span id="Pond_myName">\u0996\u09C7\u09B2\u09CB\u09AF\u09BC\u09BE\u09A1\u09BC</span></div>';
};
if (goog.DEBUG) {
...
Pond.Duck.soy.toolbox = function(opt_data, opt_ignored, opt_ijData) {
  return '<xml id="toolbox" style="display: none;"><category name="\u09AA\u09C1\u0995\u09C1\u09B0"><block type="pond_cannon"><value name="DEGREE"><shadow type="pond_math_number"><mutation angle_field="true"></mutation><field name="NUM">0</field></shadow></value><value name="RANGE"><shadow type="pond_math_number"><mutation angle_field="false"></mutation><field name="NUM">70</field></shadow></value></block><block type="pond_scan"><value name="DEGREE"><shadow type="pond_math_number"><mutation angle_field="true"></mutation><field name="NUM">0</field></shadow></value></block><block type="pond_swim"><value name="DEGREE"><shadow type="pond_math_number"><mutation angle_field="true"></mutation><field name="NUM">0</field></shadow></value></block><block type="pond_stop"></block><block type="pond_getX"></block><block type="pond_getY"></block><block type="pond_speed"></block><block type="pond_health"></block></category><category name="\u09AF\u09C1\u0995\u09CD\u09A4\u09BF"><block type="controls_if"></block><block type="logic_compare"></block><block type="logic_operation"></block><block type="logic_boolean"></block></category><category name="\u09B2\u09C1\u09AA\u09B8\u09AE\u09C2\u09B9"><block type="controls_whileUntil"></block></category><category name="\u0997\u09A3\u09BF\u09A4"><block type="pond_math_number"><mutation angle_field="false"></mutation></block><block type="math_arithmetic"><value name="A"><shadow type="math_number"><field name="NUM">1</field></shadow></value><value name="B"><shadow type="math_number"><field name="NUM">1</field></shadow></value></block><block type="pond_math_single"><value name="NUM"><shadow type="math_number"><field name="NUM">9</field></shadow></value></block><block type="math_random_float"></block></category><sep></sep><category name="\u099A\u09B2\u0995\u0997\u09C1\u09B2\u09CB" custom="VARIABLE"></category><category name="\u0995\u09CD\u09B0\u09BF\u09AF\u09BC\u09BE" custom="PROCEDURE"></category></xml>';
};
if (goog.DEBUG) {
