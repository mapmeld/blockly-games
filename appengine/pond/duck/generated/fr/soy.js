...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Lapin</span><span id="Pond_counterName">Compteur</span><span id="Pond_rookName">Tour</span><span id="Pond_sniperName">Tireur</span><span id="Pond_myName">Joueur</span></div>';
};
if (goog.DEBUG) {
