...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Zomo</span><span id="Pond_counterName">Mai lissafi</span><span id="Pond_rookName">Zakara</span><span id="Pond_sniperName"> Mai la\u0253iyar harbi</span><span id="Pond_myName">Mai wasa</span></div>';
};
if (goog.DEBUG) {
