...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Lapin</span><span id="Pond_counterName">Conteur</span><span id="Pond_rookName">Tor</span><span id="Pond_sniperName">Tirador</span><span id="Pond_myName">Giugador</span></div>';
};
if (goog.DEBUG) {
