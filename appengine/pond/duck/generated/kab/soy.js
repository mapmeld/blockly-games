...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Awtul</span><span id="Pond_counterName">Amesmi\u1E0Dan</span><span id="Pond_rookName">Tane\u1E0D\u1E0Daft</span><span id="Pond_sniperName">Aselfa\u0263</span><span id="Pond_myName">Ame\u0263ri</span></div>';
};
if (goog.DEBUG) {
