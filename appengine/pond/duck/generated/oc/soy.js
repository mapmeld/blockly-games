...
Pond.Duck.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return Pond.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Pond_rabbitName">Conilh</span><span id="Pond_counterName">Comptador</span><span id="Pond_rookName">Torre</span><span id="Pond_sniperName">Tiraire</span><span id="Pond_myName">Jogaire</span></div>';
};
if (goog.DEBUG) {
