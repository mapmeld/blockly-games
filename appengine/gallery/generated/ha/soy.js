...
Gallery.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return BlocklyGames.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Movie_submitDisabled">Fim \u0257inka baya motsawa. Yi amfani da bululluka domin yin wani abu mai ban sha\u2019awa. Sannan za ka iya mi\u0199a fim \u0257inka zuwa galari.</span></div>';
};
if (goog.DEBUG) {
...
Gallery.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return '<table width="100%"><tr><td><h1>' + BlocklyGames.soy.titleSpan({appName: soy.$$escapeHtml(opt_ijData.appName) + 'Galari'}, null, opt_ijData) + '</h1></td><td class="farSide"><select id="languageMenu"></select></td></tr></table><div id="gallery"></div><div id="loading"><img src="common/loading.gif"></div>';
};
if (goog.DEBUG) {
