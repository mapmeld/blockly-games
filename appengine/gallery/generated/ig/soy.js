...
Gallery.soy.messages = function(opt_data, opt_ignored, opt_ijData) {
  return BlocklyGames.soy.messages(null, null, opt_ijData) + '<div style="display: none"><span id="Movie_submitDisabled">Ihe nkiri g\u1ECB ad\u1ECBgh\u1ECB agaghar\u1ECB. Jiri ng\u1ECDng\u1ECD iji mee ihe na-ad\u1ECDr\u1ECD mmas\u1ECB. Mgbe ah\u1EE5 \u1ECB nwere ike \u1ECBnyefee ihe nkiri g\u1ECB na galeri.</span></div>';
};
if (goog.DEBUG) {
...
Gallery.soy.start = function(opt_data, opt_ignored, opt_ijData) {
  return '<table width="100%"><tr><td><h1>' + BlocklyGames.soy.titleSpan({appName: soy.$$escapeHtml(opt_ijData.appName) + 'Galeri'}, null, opt_ijData) + '</h1></td><td class="farSide"><select id="languageMenu"></select></td></tr></table><div id="gallery"></div><div id="loading"><img src="common/loading.gif"></div>';
};
if (goog.DEBUG) {
