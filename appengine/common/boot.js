...
(function() {
  ...
  window['BlocklyGamesLanguages'] = [
    ...
    'en', 'es', 'eu', 'fa', 'fi', 'fr', 'gl', 'ha', 'he', 'hi', 'hu', 'hy',
    'ia', 'id', 'ig', 'is', 'it', 'ja', 'kab', 'ko', 'lt', 'lv', 'ms',
    'my', 'nb', 'nl', 'pl', 'pms', 'pt', 'pt-br', 'ru', 'sc', 'sk', 'sl',
    'sq', 'sr', 'sv', 'th', 'tr', 'uk', 'ur', 'vi', 'yo', 'zh-hans', 'zh-hant'
  ];
  ...
  var lang = param ? param[1] : 'ha'; // param ? param[1].replace(/\+/g, '%20') : null;
